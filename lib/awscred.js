...
function loadCredentials(options, cb) {
  ...
  function nextCall(i) {
    credentialsCallChain[i](options, function(err, credentials) {
      ...
      if (i >= credentialsCallChain.length - 1) { return cb(null, {}) }
...
function loadRegion(options, cb) {
  ...
  function nextCall(i) {
    regionCallChain[i](options, function(err, region) {
      ...
      if (region) { return cb(null, region) }

      if (i >= regionCallChain.length - 1) { return cb(null, 'us-east-1') }
